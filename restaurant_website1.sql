...
(2, 'Hamburger', ', Hamburger is a classic dish featuring a seasoned ground meat patty, grilled or fried, served in a soft bun and garnished with various toppings like lettuce, tomato, and condiments', 3.80, 'burger.jpeg', 1),
(3, 'Ice Cream', '
A delightful frozen treat, ice cream is a sweet and creamy dessert made from a mixture of milk or cream, sugar, and flavorings. It comes in a variety of flavors and is often enjoyed in cones, cups, or as a topping for other desserts.', 7.50, 'summer-dessert-sweet-ice-cream.jpg', 2),
(5, 'Coffee', '
A popular caffeinated beverage, coffee is brewed from roasted coffee beans, delivering a rich and aromatic flavor. Served hot or cold, it has become a global favorite, offering a diverse range of styles from espresso to lattes, and is often enjoyed for its stimulating effects.', 10.00, 'coffee.jpeg', 3),
(6, 'Ice Tea', 'Iced tea is a refreshing beverage made by steeping tea leaves in hot water, then chilling the concoction and serving it over ice. Commonly flavored with lemon and sweetened to taste, it provides a cool and revitalizing option, particularly popular during warm weather.', 3.20, '76643_ice_tea.jpg', 3),
(7, 'Bucatini', '
Bucatini is a type of pasta characterized by its long, thick, and hollow strands, resembling thick spaghetti with a hole running through the center. This versatile pasta is often used in Italian cuisine and pairs well with a variety of sauces, from simple tomato-based ones to heartier meat sauces.', 20.00, 'macaroni.jpeg', 4),
(8, 'Cannelloni', 'Cannelloni is a type of pasta that consists of large tubes, typically cylindrical in shape, which are filled with a savory stuffing such as ricotta cheese, spinach, meat, or a combination of ingredients. These stuffed tubes are then baked in the oven and often topped with a flavorful sauce, creating a delicious and hearty Italian dish.', 10.00, 'cooked_pasta.jpeg', 4),
(9, 'Margherita', 'Margherita pizza is a classic Italian pizza topped with simple yet flavorful ingredients. It features a thin crust, tomato sauce, fresh mozzarella cheese, fresh basil leaves, and a drizzle of olive oil. This pizza showcases the colors of the Italian flag with its red tomatoes, white mozzarella, and green basil.', 24.00, 'pizza.jpeg', 5),
(11, 'Moroccan Tajine', 'Moroccan tajine is a slow-cooked stew, combining meat, vegetables, and spices for a flavorful dish. Named after the clay pot it's cooked in, the tajine offers a unique blend of textures and tastes, embodying the rich culinary traditions of Morocco.', 20.00, '58146_Moroccan Chicken Tagine.jpeg', 8),
...
(16, 'Couscous', '
Couscous is a staple in North African cuisine, made from crushed and steamed wheat granules. With its light, fluffy texture, couscous serves as a versatile base for various dishes, often paired with savory stews, vegetables, or meats, creating a popular and quick-to-prepare meal in many cultures.', 20.00, '76635_57738_w1024h768c1cx256cy192.jpg', 8);
