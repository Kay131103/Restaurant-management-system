				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Experience culinary excellence with our dishes crafted from the finest, freshest ingredients sourced from organic farms.
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Satisfy your cravings in a flash with our instant food delivery service—delicious meals, delivered to your door in no time
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Savor the moment with our dishes, where every bite unfolds a symphony of delicious flavors to delight your palate.
	                        </p>
	                    </div>
	                </div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <p>
                            Our Restaurant is one of the best, provide tasty Menus and Dishes. You can reserve a table or Order food.
                        </p>
